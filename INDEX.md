...
> **Last updated:** Monday, 31st August, 2026 9:24 AM
...
- **`01_PIPELINE_EXTRACTION_TAGS/01D_PAGE_BOUNDARIES_TAG_TAXONOMY.md`** (19 KB) — Page boundary system; tag taxonomy & normalisation (incl. the five tolerant-match `ai_guidelines_pdf` media rows — constraint 84)
...
- **`02_DATA_CONTENT_VERIFICATION/02C_VERIFICATION_CHECKLIST.md`** (22 KB) — Verification checklist (unchanged and still run in full; **constraint 88** banner — run every check, narrate almost none: a passing check is silent, a failing one becomes a plain-English red flag)
...
- **`12_CHANGE_LEDGER/12E5_CHANGE_HISTORY_CL0085_ONWARD.md`** (28 KB) — PART 3 change history: CL-0085 onward (continued) — THE OPEN PART: append new CL entries here

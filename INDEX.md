...
> **Last updated:** Sunday, 20th September, 2026 8:27 PM
...
- One folder per skill, each holding a single `SKILL.md`: tekura-conversion-mode (Mode 1) · tekura-advisory-support-mode (2) · **tekura-module-comparison-mode** (3, `09`) · **tekura-assessment-comparison-mode** (3, `18C`) · tekura-update-mode (4) · tekura-split-mode (5) · tekura-interactives-mode (6) · tekura-pageforge-compare-mode (7) · tekura-admin-mode (8) · tekura-assessment-mode (9)

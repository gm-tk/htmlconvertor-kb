...
- **`00_MASTER_INSTRUCTIONS/00D_CONSTRAINTS_1.md`** (30 KB) — Constraints quick reference, part 1 of 4 — **constraints 1–57** (constraint 1 now lists the label-prefix strip among the permitted format normalisations — CL-0095)
...
- **`01_PIPELINE_EXTRACTION_TAGS/01D_PAGE_BOUNDARIES_TAG_TAXONOMY.md`** (21 KB) — Page boundary system; tag taxonomy & normalisation (incl. the five tolerant-match `ai_guidelines_pdf` media rows — constraint 84, with the renamed `responding` row and its still-matched retired wording, CL-0094)
...
- **`01_PIPELINE_EXTRACTION_TAGS/01F_TAG_INTERPRETATION_STYLING_ACTIVITIES.md`** (6 KB) — Tag interpretation, second half: content styling, activities, links & buttons, interactive components. Opened 14 September 2026 when `01E` passed the 30 KB soft limit; content moved verbatim from `01E`
...
- **`02_DATA_CONTENT_VERIFICATION/02C_VERIFICATION_CHECKLIST.md`** (26 KB) — Verification checklist, incl. a **Language Fonts** block (constraint 92) (unchanged and still run in full; **constraint 88** banner — run every check, narrate almost none: a passing check is silent, a failing one becomes a plain-English red flag)
...
## 12_CHANGE_LEDGER
- **`12_CHANGE_LEDGER/12A_LEDGER_CORE_AND_LOCKS.md`** (16 KB) — Ledger purpose, status values (incl. **`Locked (admin)`**), PART 1 locked decisions (**CL-0086 to CL-0094**), PART 2 pending approval
...
- **`12_CHANGE_LEDGER/12E5_CHANGE_HISTORY_CL0085_0092.md`** (29 KB) — PART 3 change history: CL-0085 to CL-0092 (continued) — CLOSED at CL-0092 (14 September 2026, 30 KB soft limit)
  - Sections: PART 3 history rows CL-0085 to CL-0092
- **`12_CHANGE_LEDGER/12E6_CHANGE_HISTORY_CL0093_ONWARD.md`** (12 KB) — PART 3 change history: CL-0093 onward (continued) — THE OPEN PART: append new CL entries here
  - Sections: PART 3 history rows CL-0093 onward

...
| The message contains `COMPARISON MODE` + uploaded finished HTML (and **not** the leading word `PAGEFORGE`) | `09_COMPARISON_MODE.md` (whole file) |
